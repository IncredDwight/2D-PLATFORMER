...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if(collision.gameObject.GetComponent<Enemy>() != null || collision.gameObject.GetComponent<DamageOnCollision>() != null)
        KnockBack(new Vector2(10, _playerStats.Rigidbody2D.velocity.y));        
    }
